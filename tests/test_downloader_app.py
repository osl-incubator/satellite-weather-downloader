...
def test_import_package():
    ...
    assert extract_reanalysis.__name__ == 'satellite_weather_downloader.extract_reanalysis'
...
def test_extract_latlons_from_geocode_n_extract_coord_from_latlons():
    ...
    from satellite_weather_downloader.utils.extract_coordinates import from_latlon
    
    latlon_rio_de_janeiro = from_geocode(3304557)
    latlon_florianopolis = from_geocode(4205407)

    coord_rio_de_janeiro = from_latlon(latlon_rio_de_janeiro[0], latlon_rio_de_janeiro[1])
    coord_florianopolis = from_latlon(latlon_florianopolis[0], latlon_florianopolis[1])
